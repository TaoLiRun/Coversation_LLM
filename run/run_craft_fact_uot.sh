...
python ../src/mediQ_benchmark.py \
 --expert_model="llama" --expert_module uot_expert --expert_class UoTExpert\
 --patient_model="deepseek" --patient_class FactSelectPatient\
 --data_dir ../data --dev_filename all_craft_md.jsonl \
 --output_filename ../logs/craft_fact_uot.jsonl \
 --max_questions 5 --log_filename ../logs/craft_fact_uot_result.log
