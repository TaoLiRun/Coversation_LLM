...
python ../src/mediQ_benchmark.py \
 ...
 --patient_model="deepseek" --patient_class RandomPatient\
 --data_dir ../data --dev_filename all_craft_md.jsonl \
 --output_filename ../logs/craft_random_fixed.jsonl \
 --max_questions 5 --log_filename ../logs/craft_random_fixed_result.log
