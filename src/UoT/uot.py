import numpy as np
import pdb
from .chat_utils import ques_and_cls_given_items, cls_given_repo, initialize_open_set, renew_open_set


class UoTNode:
    def __init__(self, question, answer, items, parent: 'UoTNode' = None, model="llama", reply=None):
        self.children = []
